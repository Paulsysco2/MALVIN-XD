...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "malvin~IiVmQBiL#WWvK4xJvd4NhiHWZy7isaD0RtUAw3ECtXV9mYEEle1s",
// add your Session Id make sure it starts with malvin~
PREFIX: process.env.PREFIX || "🧛",
// add your prifix for bot   
BOT_NAME: process.env.BOT_NAME || "LORENZO-MD",
...
// add alive msg here 
        ...
        STICKER_NAME: process.env.STICKER_NAME || "LORENZO-MD",
...
// add bot owner name
              ...
              DESCRIPTION: process.env.DESCRIPTION || "*New WhatsApp bot by 𝐖𝐎𝐋𝐕𝐄𝐒 ＬＯＲＥＮＺＯ🧛*",
// add bot owner name    
